...
<body>
	...
	<div class="container">
		...
		<form action="cadastroBanco.jsp" method="POST">
			...
			<div class="form-group">
				<label for="speed">Velocidade: </label> <input type="text"
			...
			<div class="form-group">
				<label for="modulos">Módulos: </label> <input type="text"
					class="form-control" name="modulos">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<div class="form-group">
					...
					<input type="hidden" name="opcao" value="ram" />
				</div>
			</div>
